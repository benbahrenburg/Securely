...
#import <Security/Security.h>
	...
	#define BxSSKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#ifdef BxSSKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, BxSSKeychainQuerySynchronizationMode) {
	BxSSKeychainQuerySynchronizationModeAny,
	BxSSKeychainQuerySynchronizationModeNo,
	BxSSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface BxSSKeychainQuery : NSObject
...
@property (nonatomic) BxSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
