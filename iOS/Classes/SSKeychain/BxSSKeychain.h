...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, BxSSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	BxSSKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
extern NSString *const kBxSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kBxSSKeychainAccountKey;
 ...
 */
extern NSString *const kBxSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBxSSKeychainClassKey;

/** Item description. */
extern NSString *const kBxSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBxSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kBxSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBxSSKeychainWhereKey;
 ...
 */
@interface BxSSKeychain : NSObject
